...
export const FounderProfilePage: React.FC<FounderProfilePageProps> = ({
  ...
  const getTotalShares = () => {
    return founderProjects.reduce((total, project) => total + (project.shares_in_pool || 0), 0);
  };
  ...
  return (
    <div className={`min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 ${className}`}>
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
          <div className="flex flex-col md:flex-row items-start md:items-center space-y-4 md:space-y-0 md:space-x-6">
            ...
            <div className="relative">
              ...
              {isEditing && (
                <div className="absolute -bottom-2 -right-2 bg-blue-600 text-white rounded-full p-2 cursor-pointer hover:bg-blue-700 transition-colors">
            ...
            <div className="flex-1">
              {isEditing ? (
                ...
                <div>
                  ...
                  <p className="text-gray-600 mb-2">{founderUser.email}</p>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-gray-900">{founderProjects.length}</p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <div className="flex items-center justify-between mb-6">
            ...
            <span className="bg-blue-100 text-blue-800 px-3 py-1 rounded-full text-sm font-medium">
              {founderProjects.length} {founderProjects.length === 1 ? 'Project' : 'Projects'}
            </span>
          </div>
          ...
          {founderProjects.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {founderProjects.map((project) => {
                ...
                return (
                  <div key={project.id} className="bg-gradient-to-br from-white to-gray-50 rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow">
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex-1">
                        <h3 className="text-lg font-bold text-gray-900 mb-2">{project.name}</h3>
                        {project.bio && (
                          <p className="text-gray-600 text-sm line-clamp-2">{project.bio}</p>
                        )}
                      </div>
                      {project.logo_url && (
                        <img
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span className="font-bold text-gray-900">${marketCap.toLocaleString()}</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-sm text-gray-600">Shares in Pool</span>
                        <span className="font-bold text-gray-900">{project.shares_in_pool?.toLocaleString()}</span>
                      </div>
                      <div className="flex justify-between items-center">
        ...
        {error && (
          <div className="mt-8 bg-red-50 border border-red-200 text-red-700 px-6 py-4 rounded-xl">
            <div className="flex items-center">
